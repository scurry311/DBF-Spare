...
$target = [System.IO.Path]::GetFullPath(
    (Join-Path $projectRoot 'hfss_outputs\grounded_patch_direct_16x16_staged_convergence_20260717_run01\grounded_patch_16x16\grounded_patch_16x16.aedtresults')
)
