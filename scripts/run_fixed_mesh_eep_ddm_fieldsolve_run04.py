#!/usr/bin/env python3
"""Run the field-enabled DDM solve with 75% RAM and guarded off-core use."""
...
field.OUT_DIR = (
    field.ROOT / "hfss_outputs" / "fixed_mesh_eep_fieldsolve_20260723_run04_ddm75"
)
field.TARGET_NAME = "fixed_mesh_eep_ddm_fieldsolve_run04"
field.TARGET_PROJECT = field.OUT_DIR / "project" / f"{field.TARGET_NAME}.aedt"
field.SETUP_NAME = "Setup_Frozen_DDM_EEP_Run04"
field.TOUCHSTONE = field.OUT_DIR / "solve" / "fixed_mesh_eep_ddm_fieldsolve.s256p"
field.MIN_D_FREE_GB = 85.0
field.MIN_COMMIT_HEADROOM_GB = 25.5
field.MIN_PHYSICAL_AVAILABLE_GB = 14.0
field.AEDT_DISTRIBUTED_MACHINE_LIST = "list=scurry:1:4:75%:0"
field.CRITICAL_PHYSICAL_GB = 0.35
field.CRITICAL_COMMIT_GB = 0.75
