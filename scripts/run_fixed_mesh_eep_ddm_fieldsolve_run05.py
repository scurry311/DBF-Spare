#!/usr/bin/env python3
"""Run the field-enabled DDM solve at the minimum viable 80% RAM limit."""
...
field.OUT_DIR = (
    field.ROOT / "hfss_outputs" / "fixed_mesh_eep_fieldsolve_20260723_run05_ddm80"
)
field.TARGET_NAME = "fixed_mesh_eep_ddm_fieldsolve_run05"
field.TARGET_PROJECT = field.OUT_DIR / "project" / f"{field.TARGET_NAME}.aedt"
field.SETUP_NAME = "Setup_Frozen_DDM_EEP_Run05"
